...
let info_isVisited = sessionStorage.getItem('info-isVisited');

if (info_isVisited === null) {
    h1.style.animation = "showBar_alt 2s linear";
    h1.style.setProperty("--block-animation", "cursorBlocking 1s linear");
    line.style.animation = "renderLine_alt_0 2s linear";
    sessionStorage.setItem("info-isVisited", "true");
}
else {
