...
let aboutme_isVisited = sessionStorage.getItem('aboutme-isVisited');

if (aboutme_isVisited === null) {
    ...
    sessionStorage.setItem("aboutme-isVisited", "true");
}
else {
