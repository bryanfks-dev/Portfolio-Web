        ...
        <section id="about-web">
            ...
            <div class="section-content">
                <p data-aos="fade-up" data-aos-delay="100" data-aos-once="true">
                    The first version of this website was made in 2021. So, there was a project for my English
                    ...
                    <div class="tech-stack">
                        ...
                        <div data-aos="fade-up" data-aos-delay="300" data-aos-once="true">
                            ...
                            <ul class="stack">
                                ...
                                <!-- Laravel -->
                                <li>
                                    <svg height="24" width="24" viewBox="0 -.11376601 49.74245785 51.31690859"
                                    ...
                                    <a target="_blank" rel="noreferrer noopener" href="https://laravel.com/">Laravel</a>
                                </li>
                                <!-- Swiper -->
                                <li>
                                    ...
                                    <a target="_blank" rel="noreferrer noopener" href="https://swiperjs.com/">Swiper</a>
                                </li>
                                <!-- AOS -->
                                <li>
                            ...
                            <ul class="stack">
                                ...
                                <li>
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                        ...
                                        <g data-name="Photo Surface">
                                            <rect width="240" height="232" x="8" y="12" fill="#001e36"
                                                rx="42">
                                            </rect>
                                        </g>
                                        <path fill="#31a8ff"
                                ...
                                <li>
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                        data-name="Layer 1" viewBox="0 0 256 256">
                                        <g>
                                            <rect width="240" height="232" x="8" y="12" fill="#300"
                                                rx="42"></rect>
                                        </g>
                                        <path fill="#ff9a00"
                                ...
                                <li>
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                                        fill="none" viewBox="0 0 72 72" id="iconscout-logo">
